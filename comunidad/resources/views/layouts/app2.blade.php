            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('ciudadanos') }}">Listado</a>
                        <a class="collapse-item" href="{{ route('registro') }}">Registro</a>
                        <a class="collapse-item" href="{{ route('actividades.ciudadanos') }}">Actividades</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{route('barrios')}}">
